        ...
        public PulsarMod LoadMod(string assemblyPath)
        {
            ...
            try
            {
                ...
                if (modType != null)
                {
                    ...
                    Logger.Info($"Loaded {modType.ToString()}: {mod.Name}, Version: {mod.Version}, Author: {mod.Author}, License: {mod.License}, SourceURL: {(mod.SourceURL.Length != 0 ? mod.SourceURL : "N/A")}");
