using PulsarManager.Chat.Commands;
using PulsarManager.Utilities;
using System;
using System.Collections.Generic;

namespace PulsarManager.Chat.Extensions
{
    class HandlePublicCommands : ModMessage
    {
        private static readonly string harmonyIdentifier = "";
        private static readonly string handlerIdentifier = "PulsarManager.Chat.Extensions.HandlePublicCommands";
