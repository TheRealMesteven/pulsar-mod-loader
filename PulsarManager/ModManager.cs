...
using PulsarManager.MPModChecks;
...
namespace PulsarManager
{
    ...
    public class ModManager
    {
        ...
        public void LoadModsDirectory(string modsDir)
        {
            ...
            _ = PulsarManager.Content.Items.ItemModManager.Instance;
            _ = PulsarManager.Content.Components.AutoTurret.AutoTurretModManager.Instance;
            _ = PulsarManager.Content.Components.CaptainsChair.CaptainsChairModManager.Instance;
            _ = PulsarManager.Content.Components.CPU.CPUModManager.Instance;
            _ = PulsarManager.Content.Components.Extractor.ExtractorModManager.Instance;
            _ = PulsarManager.Content.Components.FBRecipeModule.FBRecipeModuleModManager.Instance;
            _ = PulsarManager.Content.Components.Hull.HullModManager.Instance;
            _ = PulsarManager.Content.Components.HullPlating.HullPlatingModManager.Instance;
            _ = PulsarManager.Content.Components.InertiaThruster.InertiaThrusterModManager.Instance;
            _ = PulsarManager.Content.Components.ManeuverThruster.ManeuverThrusterModManager.Instance;
            _ = PulsarManager.Content.Components.MegaTurret.MegaTurretModManager.Instance;
            _ = PulsarManager.Content.Components.Missile.MissileModManager.Instance;
            _ = PulsarManager.Content.Components.MissionShipComponent.MissionShipComponentModManager.Instance;
            _ = PulsarManager.Content.Components.NuclearDevice.NuclearDeviceModManager.Instance;
            _ = PulsarManager.Content.Components.PolytechModule.PolytechModuleModManager.Instance;
            _ = PulsarManager.Content.Components.Reactor.ReactorModManager.Instance;
            _ = PulsarManager.Content.Components.Shield.ShieldModManager.Instance;
            _ = PulsarManager.Content.Components.Thruster.ThrusterModManager.Instance;
            _ = PulsarManager.Content.Components.Turret.TurretModManager.Instance;
            _ = PulsarManager.Content.Components.Virus.VirusModManager.Instance;
            _ = PulsarManager.Content.Components.WarpDrive.WarpDriveModManager.Instance;
            _ = PulsarManager.Content.Components.WarpDriveProgram.WarpDriveProgramModManager.Instance;
