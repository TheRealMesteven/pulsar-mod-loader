...
using UnityEngine;
using static PulsarManager.Patches.HarmonyHelpers;
using Logger = PulsarManager.Utilities.Logger;

namespace PulsarManager.Content.Components.FBRecipeModule
{
    ...
    class RecipeDisplayIconPatch
    {
        ...
        static Sprite GetSprite(PLFBRecipeModule recipeModule)
        {
            ...
            if(inpath == string.Empty)
            {
                ...
                throw new Exception("PulsarManager.Content.FBModuleModManager.RecipeDisplayIconPatch - Recipe Module not found");
            }
    ...
    class ServerTakeBiscuitPatch
    {
        ...
        static int[] PatchMethod(PLFluffyOven instance)
        {
            ...
            if (module.GetBiscuitTypeToProduce() == EFoodType.MAX)
            {
                ...
                {
                    throw new Exception("PulsarManager.Content.FBModuleModManager.ServerTakeBiscuitPatch - Foodtype max with no module found");
                }
            }
            else
            {
