...
namespace PulsarManager.SaveData
{
    class SaveDataManager
    {
        ...
        public void SaveDatas(BinaryWriter writer)
        {
            ...
            foreach (PMLSaveData saveData in SaveConfigs)
            {
                try
                {
                    PulsarManager.Utilities.Logger.Info($"Writing: {saveData.MyMod.HarmonyIdentifier()}::{saveData.Identifier()} pos: {writer.BaseStream.Position}");
