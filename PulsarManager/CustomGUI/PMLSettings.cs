...
namespace PulsarManager.CustomGUI
{
    class PMLSettings : ModSettingsMenu
    {
        public override string Name() => "PulsarManager";
        ...
        public override void Draw()
        {
            if (Button("Debug Mode: " + (PMLConfig.DebugMode ? "Enabled" : "Disabled")))
            {
                ...
                {
                    PLInGameUI.Instance.CurrentVersionLabel.text = PulsarManager.Patches.GameVersion.Version;
                }
            }
